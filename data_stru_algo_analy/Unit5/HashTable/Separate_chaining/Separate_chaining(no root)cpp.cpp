...
//
///*
// no header of HashTable
//*/
//template <class T>
//class HashTable
//{
//private:
//	LinkedList_Node<T> ** Top_Ptr;
//	int HashTable_Size;
//public:
...
//	std::cout << std::endl;
//	Traversal(header + 1);*/
//	LinkedList_Node<T> ** header = Top_Ptr;
//	for (int i = 0; i < HashTable_Size; ++i) {
//		LinkedList_Node<T> * tmpcell = header[i];
//		while (tmpcell != nullptr)
//		{
//			std::cout << tmpcell->_data << " ";
//			tmpcell = tmpcell->Next;
...
//{
//	Top_Ptr = new LinkedList_Node<T>*[Size];//allocate  HashTable
...
//{
//	if (nullptr == Top_Ptr[Hash_Calc(data)])
//	{
//		Top_Ptr[Hash_Calc(data)] = new LinkedList_Node<T>(data);
//	}
//	else 
//	{
//		LinkedList_Node<T> * tmpcell = Top_Ptr[Hash_Calc(data)];
